...
public class Car_update_detail extends Fragment {
    ...
    {
        View v = inflater.inflate(R.layout.car_update_detail_view,container,false);

        Bundle args = getArguments();
        car = (Car) args
                .getSerializable("car");

        System.out.println("price in update oncreateview:"+ car.getPrice());
        ...
        if(car.getRented().equalsIgnoreCase("1")) {
        ...
        File mPhotoFile = pictureUtils.getPhotoFile(getActivity(),car);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch(item.getItemId())
        {
            case R.id.menu_save:
                ...
                System.out.println("price in update:"+ price.getText().toString());
                ...
                frag.popFragByName(getActivity(),"Car_update_detail");
                return true;
            default:
